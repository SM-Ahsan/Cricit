...
<div class="article-index">
	...
	<div class="row">
		<div class="col-md-8" >
			<h2 class="page-header">Create News:</h2>		
		</div>

		<div class="col-md-4" >
			<a href="index.php?r=news/view" class="pull-right btn btn-info">View All</a>	
		</div>	
	</div>
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?= $form->field($news, 'data')->textArea(['rows'=>'20']); ?>

        <div class="form-group">
            <?= Html::submitButton('Save News', ['class' => 'btn btn-primary']) ?>
        </div>
